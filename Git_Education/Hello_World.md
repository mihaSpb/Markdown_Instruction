# Конспект лекций по курсу "Введение в контроль версий". Составитель: Морозов Михаил
# Лекция 1
...
~~Зачеркнутый текст~~ - в VSC зачеркнутый текст работает, в стороннем редакторе - нет.
...
3. [Ссылка со сноской][Произвольный регистрозависимый текст]
...
[Произвольный регистрозависимый текст]: https://gb.ru
[1]: https://gb.ru
...
Это составная команда, которая выкачивает данные из удаленного репозитория и делает слияние с локальным репозиторием.
